...
from pre_commit_starter.main import (
...
class TestUserPreferences:
    ...
    def test_ask_user_preferences_accept_all_defaults(self):
        ...
        with patch("pre_commit_starter.main.Confirm.ask", return_value=True):
            with patch("pre_commit_starter.main.Prompt.ask", return_value=""):
                with patch("pre_commit_starter.main.console"):
    ...
    def test_ask_user_preferences_python_version_prompt(self):
        ...
        with patch("pre_commit_starter.main.Confirm.ask", return_value=True):
            with patch("pre_commit_starter.main.Prompt.ask", return_value="python3.11"):
                result = ask_user_preferences(detected_config)
